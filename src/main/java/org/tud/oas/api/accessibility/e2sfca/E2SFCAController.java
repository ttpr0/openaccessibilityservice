...
@RestController
@RequestMapping("/v1/accessibility/enhanced_2sfca")
public class E2SFCAController {
    private final Logger logger = LoggerFactory.getLogger(E2SFCAController.class);
    ...
    @Autowired
    public E2SFCAController(RoutingService routing, DemandService demand, SupplyService supply, DecayService decay) {
    ...
    @Operation(description = """
            Calculates enhanced two-step-floating-catchment-area.
            """)
    ...
    @PostMapping
    public AccessResponse calcFCA(@RequestBody E2SFCARequest request) {
